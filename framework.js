...
var js = {
    ...
    getEventXY: function(ev) {
        ...
        if (ev.touches && ev.touches.length > 0) {
            ...
            x = ev.pageX ? ev.pageX : ev.clientX;
            y = ev.pageY ? ev.pageY : ev.clientY;
        }
        return {
            x: x,
            y: y
...
js.array = function(arg) {
    this.__id = arg ? arg.id : js.generateId();
    this._items = [];
